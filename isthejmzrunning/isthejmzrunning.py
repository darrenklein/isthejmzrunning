...
def index():
    ...
    line_info = HandleData.process_results(bdfm_request, jz_request, one_request, a_request, n_request, l_request, g_request, seven_request)
    line_statuses = HandleData.assess_results(line_info, route_list)
